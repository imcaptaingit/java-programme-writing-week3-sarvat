 ...
 * English marks (marks is between 0 and 100 and if it is out of range print error message &ldquo;Invalid
 * Input, Marks should between 0 to 100&rdquo;) and find out total, percentage and result.
